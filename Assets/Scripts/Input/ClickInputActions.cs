...
//     version 1.14.2
//     from Assets/Scripts/Input/ClickInputActions.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Scripts/Input/ClickInputActions.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @ClickInputActions: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    /// </summary>
    public @ClickInputActions()
    {
        asset = InputActionAsset.FromJson(@"{
    ""version"": 1,
    ""name"": ""ClickInputActions"",
    ""maps"": [
        {
            ""name"": ""Click"",
            ""id"": ""655e789c-db27-4eab-8666-8876495ff9fd"",
            ""actions"": [
                {
                    ""name"": ""Click"",
                    ""type"": ""Button"",
                    ""id"": ""f7f17c74-198b-425e-8a49-b27e4c4078c9"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""b7561f07-d217-41e3-a66c-3d2390dabff7"",
                ...
                {
                    ""name"": """",
                    ""id"": ""73f7d94d-5a98-42d8-add8-191a667676e7"",
    ...
    ~@ClickInputActions()
    {
        UnityEngine.Debug.Assert(!m_Click.enabled, "This will cause a leak and performance issues, ClickInputActions.Click.Disable() has not been called.");
    }
    ...
    {
        private @ClickInputActions m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public ClickActions(@ClickInputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
